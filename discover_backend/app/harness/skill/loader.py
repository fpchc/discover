...
from app.harness.skill.contract import check_agent_manifest, check_skill_manifest
...
from app.harness.skill.manifest import AgentManifest, SkillManifest
from app.harness.targets import GENERIC_ASSISTANT_ID
