"""本地账号管理 CLI：`python -m app.application.identity.provision --phone … [--auth-user-id …]`
...
from app.application.dto.auth import AccountStatus
from app.config.settings import Settings
from app.infrastructure.crypto.security import PasswordHasher
